        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <a href="{{ route('contacts.create') }}" class="text-blue-800">新規登録</a><br>

                    <form class="mx-auto text-center" action="{{ route('contacts.index') }}">
                        <input class="mb-8" type="text" name="search"  placeholder="検索">
