        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h1 class="font-bold">新規登録フォーム</h1>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <select name="age">
                                                    ...
                                                    <option value="2" {{ old('age') === 1 ? 'selected' : '' }}>
                                                        20歳~29歳</option>
                                                    <option value="3"{{ old('age') === 1 ? 'selected' : '' }}>
                                                        30歳~39歳</option>
                                                    <option value="4"{{ old('age') === 1 ? 'selected' : '' }}>
                                                        40歳~49歳</option>
                                                    <option value="5"{{ old('age') === 1 ? 'selected' : '' }}>
                                                        50歳~59歳</option>
                                                    <option value="6"{{ old('age') === 1 ? 'selected' : '' }}>60歳~
                                                    </option>
                                                </select>
