        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <input value="{{ $contact->name }}" type="text" id="name"
                                                    name="name"
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <input value=" {{ $contact->title }}" type="text" id="title"
                                                    name="title"
                                                    class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <input value=" {{ $contact->email }}" type="email" id="email"
                                                    name="email"
                                                    class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <input value=" {{ $contact->url }}" type="url" id="url"
                                                    name="url"
                                                    class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <input @if ($contact->gender === 0) @checked(true) @endif
                                                    type="radio" name="gender" value="0">男性
                                                <input @if ($contact->gender === 1) @checked(true) @endif
                                                    type="radio" name="gender" value="1">女性
                                            </div>
                                        </div>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <select name="age">
                                                    ...
                                                    <option value="1"
                                                        @if ($contact->age === 1) @selected(true) @endif>
                                                        ~19歳</option>
                                                    <option value="2"
                                                        @if ($contact->age === 2) @selected(true) @endif>
                                                        >20歳~29歳</option>
                                                    <option value="3"
                                                        @if ($contact->age === 3) @selected(true) @endif>
                                                        >30歳~39歳</option>
                                                    <option value="4"
                                                        @if ($contact->age === 4) @selected(true) @endif>
                                                        >40歳~49歳</option>
                                                    <option value="5"
                                                        @if ($contact->age === 5) @selected(true) @endif>
                                                        >50歳~59歳</option>
                                                    <option value="6"
                                                        @if ($contact->age === 6) @selected(true) @endif>
                                                        60歳~</option>
                                                </select>
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                <label for="contact"
                                                    class="leading-7 text-sm text-gray-600">お問い合わせ</label>
                    ...
                    <a href="{{ route('contacts.create') }}" class="text-blue-800">create</a>
                </div>
            </div>
        </div>
    </div>
